...
<div class="section__cell--s6 section__cell--<?php echo ($count%2==0) ? 'odd' : 'even'; ?> section__cell--grow" id="service_<?php echo get_the_ID(); ?>">
...
<div class="section__cell--s6 section__cell--text section__cell--<?php echo ($count%2==0) ? 'even' : 'odd'; ?> section__cell--grow section__cell--shrink<?php echo ($count%2==0) ? '-right-double' : '-double'; ?>">
