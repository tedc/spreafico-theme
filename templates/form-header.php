<?php
    ...
    $marketing_row = (!empty($_POST['marketing'])) ? '<tr style="border-bottom: 1px solid #e1e1e1;"><td style="text-align:center;padding:20px;font-size:18px;">'.__("Acconsento all'utilizzo dei dati inseriti per l'invio di eventuali comunicazioni di marketing.", 'sprfc').'</td></tr>' : '';
    $body = $name_row.$email_row.$tel_row.$message_row.$marketing_row;
