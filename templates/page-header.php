...
?>
<?php var_dump(is_page_template('template-contact.php')); ?>
<header class="header header--grid header--grow-<?php echo is_page_template('template-contact.php') ? 'lg' : 'md'; ?>" id="header">
