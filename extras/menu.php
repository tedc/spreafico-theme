...
function bem_menu($location = "main_menu", $css_class_prefix = 'main-menu', $css_class_modifiers = null, $title = null){
    ...
    $args = array(
        ...
        'container'         => false,
        'items_wrap'        => '<ul class="' . $css_class_prefix . ' ' . $modifiers . '"'.$title.'>%3$s</ul>',
